        ...
        <div className="relative bg-[#F5F5F5] page">           
            ...
            <div className="relative col-span-1 bg-[url('/pdf/fondo-especificaciones.png')] bg-cover bg-center bg-no-repeat m-5 rounded-[60px] px-12 py-12 z-10">
                    ...
                    {tipoProyecto.includes('disenoWeb') && (
                        ...
                        Sitio Web{' '}
                        <strong className="block font-black">Especificaciones Técnicas</strong>
                    </h2>
                    )}
                    
                    <div className="w-[80px] h-1 bg-[#294859] rounded-lg bg-gradient-to-r from-amber-400 to-orange-500 mt-4"></div>
                    {tipoProyecto.includes('disenoWeb') && (
                        <div className="bg-white bg-opacity-30 inline-block mt-4 px-6 py-3 rounded-full text-white font-medium text-1xl">
                            {numeroPaginas > 1
                    ...
                    <ul className="mt-4 text-white ml-5 text-sm space-y-2 custom-list-gris">
                        <li>Desarrollo desde cero</li>
                        <li>CMS: Wordpress</li>
                    ...
                    <div className="mt-4">
                        ...
                        <div className="text-white text-sm max-w-sm">
                            <ul className="ml-6 space-y-2 custom-list-gris">
                                {tipoProyecto.includes('tienda') && (
                                    <li className="mt-2">
                ...
                <div className="col-span-1 bg-[#F5F5F5] m-5 rounded-3xl px-8 py-14">
                    ...
                    <ul className="mt-4  text-[#294859] ml-5 text-xs space-y-2 custom-list-azul">
                        <li className="mb-2">
                    ...
                    <h3 className="text-[#294859] text-2xl font-bold mb-4 mt-6">
                        Funcionalidades
                    </h3>
                    <ul className="mt-4  text-[#294859] ml-5 text-xs space-y-2 custom-list-azul">
                        <li className="mb-2">
